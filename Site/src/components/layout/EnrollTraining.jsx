...
function EnrollTraining() {
  ...
  const fields = [
    ...
    },
    {
      ...
      type: "text",
      placeholder: `${
        split ? `First person's first name` : `Type your first name`
      }`,
    },
    {
      name: "Day of birth",
                ...
                <div className="w-full flex flex-col mb-2">
                  ...
                  <div className="w-full">
                    <input
                      ...
                      className={` ${
                        formData.errors[field.id] ? "bg-red-100" : ""
                      } ${
                        formData.fields[field.id] ? "bg-white" : ""
                    ...
                    <div
                      className={`${
                        formData.errors[field.id] ? "block" : "hidden"
                      } ${
                        formData.fields[field.id] ? "hidden" : "block"
                      } text-red-500`}
                    >
                      {field.name} is required
                    </div>
                ...
                ? splitFields.map((field) => (
                    <div className="flex flex-col mb-2" key={field.id}>
                      ...
                      <div className="w-full">
                        ...
                        <div
                          className={`${
                            splitFormData.errors[field.id] ? "block" : "hidden"
                          } ${
                            splitFormData.fields[field.id] ? "hidden" : "block"
                          } text-red-500`}
                        >
                          {field.name} is required
                        </div>
