            ...
            <div key={field.id} className="flex flex-col">
              ...
              {field.type === "select" ? (
                <div className="w-full mb-2">
                  <select
                    className={`${selectInput ? "bg-red-100" : ""} ${`${
                      typeOFLesson !== null ? "bg-white" : ""
                  ...
                  <div
                    className={`${selectInput ? "text-red-500" : "hidden"} ${
                      typeOFLesson !== null ? "hidden" : ""
                    }`}
                  >
                ...
                <div className="w-full">
                  <input
                    ...
                    className={`${
                      errors[field.id]
                        ? "bg-red-100 border-red-200 border-1"
                        : "bg-white"
                    } ${
                      formData[field.id] ? "bg-white" : ""
                    } px-4 py-2 border rounded-lg mb-1 w-full`}
                    id={field.id}
                    name={field.id}
                    type={field.type}
                  ...
                  <p
                    className={`${
                      errors[field.id] ? "text-red-500" : "hidden"
                    } ${formData[field.id] ? "hidden" : ""}`}
                  >
                ...
                ? splitOption.map((field) => (
                    <div key={field.id} className="flex flex-col mb-2">
                      ...
                      <input
                        ...
                        className={`${
                          splitErrors[field.id] ? "bg-red-100" : "bg-white"
                        } px-4 py-2 border rounded-lg ${
                          splitLessonData[field.id] ? "bg-white" : ""
                        }`}
                        id={field.id}
                        name={field.id}
                        type={field.type}
                      ...
                      <p
                        className={`${
                          splitErrors[field.id] ? "text-red-500" : "hidden"
                        } ${splitLessonData[field.id] ? "hidden" : ""}`}
                      >
                        {field.name} is required
                      </p>
                    </div>
