...
function NavBar(){
  ...
  <nav className={`flex h-18 w-full fixed top-0 left-0 right-0 lg:px-16 md:px-8 py-2 bg-white ${!isDisplayed ? 'shadow' : ''} z-50`} >
    <div className="left-section mr-auto"><Link to="hero" smooth={true} duration={300} offset={-100}><img className="cursor-pointer w-auto h-14 hover:scale-110 transition-all duration-500 " src="./src/assets/logo2.png" alt="logo" /></Link></div>
