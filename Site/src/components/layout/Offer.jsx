      ...
      <Card price={<>
        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
             ...
             <div>If you want my full attention throughout the entire lesson, this option is for you.</div>
          </div>
          <div className="mb-4">
            <div className="font-bold">Why this option?</div>
            <div>We are working with you only. We will work on your personal insecurities and fears. Individual training plan just for you</div>
          </div>
        </div>   
      ...
      <Card 
        ...
        price={
          ...
          <div className="mb-4 ">
            ...
            <div className="mb-4">
              <div className="font-bold">For who?</div>
              <div>If you have a mate or partner on a similar swimming level as you.</div>
            </div>
            <div className="mb-4">
              <div className="font-bold">Why this option?</div>
